...
import (
	...
	"github.com/elysiumchain/go-elysium/internal/jsre"
	"github.com/elysiumchain/go-elysium/internal/jsre/deps"
	"github.com/elysiumchain/go-elysium/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Elysium requests through
...
// Welcome show summary of current Gely instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gely JavaScript console!\n\n"

	// Print some generic Gely metadata
