...
# 1. install gely for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gely
# 5. create gely, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ELYSIUM_SOCKET
...
!define GROUPNAME "Elysium"
!define APPNAME "Gely"
!define DESCRIPTION "Official Go implementation of the Elysium protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gely is installed global
