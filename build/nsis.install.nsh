Name "gely ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/elysiumchain/go-elysium/issues"
!define UPDATEURL "https://github.com/elysiumchain/go-elysium/releases"
!define ABOUTURL "https://github.com/elysiumchain/go-elysium#elysium-go"
...
# Install gely binary
Section "Gely" GELY_IDX
  SetOutPath $INSTDIR
  file {{.Gely}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gely.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gely.exe" "attach"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GELY_IDX}
    SectionGetSize ${GELY_IDX} $0
