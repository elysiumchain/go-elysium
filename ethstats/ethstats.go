...
import (
	...
	ethproto "github.com/elysiumchain/go-elysium/eth/protocols/eth"
...
type backend interface {
	...
	SyncProgress() elysium.SyncProgress
}
...
// Service implements an Elysium netstats reporting daemon that pushes local
