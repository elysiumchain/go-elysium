...
import (
	...
	"github.com/elysiumchain/go-elysium/accounts/abi/bind/backends"
	...
	"github.com/elysiumchain/go-elysium/contracts/checkpointoracle/contract"
	...
	"github.com/elysiumchain/go-elysium/les/checkpointoracle"
	"github.com/elysiumchain/go-elysium/les/flowcontrol"
	vfs "github.com/elysiumchain/go-elysium/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some ely to user1
		...
		case 1:
			...
			// bankUser transfers more ely to user1
		...
		case 2:
			...
			// bankUser transfer some ely to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
