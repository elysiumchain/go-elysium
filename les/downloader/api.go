...
// Syncing provides information when this nodes starts synchronising with the Elysium network and when it's finished.
...
type SyncingResult struct {
	...
	Status  elysium.SyncProgress `json:"status"`
}
