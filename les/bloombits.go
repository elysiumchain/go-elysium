...
import (
	...
	"github.com/elysiumchain/go-elysium/common/bitutil"
	"github.com/elysiumchain/go-elysium/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Elysium
...
func (eth *LightElysium) startBloomHandlers(sectionSize uint64) {
