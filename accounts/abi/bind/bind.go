...
// Package bind generates Elysium contract Go bindings.
//
// Detailed usage document and tutorial available on the go-elysium Wiki page:
// https://github.com/elysiumchain/go-elysium/wiki/Native-DApps:-Go-bindings-to-Elysium-contracts
package bind
