...
// Package graphql provides a GraphQL interface to Elysium node data.
package graphql
...
// Account represents an Elysium account at a particular block.
type Account struct {
...
// Transaction represents an Elysium transaction.
...
// Block represents an Elysium block.
...
type CallData struct {
	From                 *common.Address // The Elysium address the call is from.
	To                   *common.Address // The Elysium address the call is to.
