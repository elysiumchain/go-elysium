...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gely.ipc", false, filepath.Join(os.TempDir(), "gely.ipc")},
		{"data", "gely.ipc", false, "data/gely.ipc"},
		{"data", "./gely.ipc", false, "./gely.ipc"},
		{"data", "/gely.ipc", false, "/gely.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gely.ipc", true, `\\.\pipe\gely.ipc`},
		{"data", "gely.ipc", true, `\\.\pipe\gely.ipc`},
		{"data", `\\.\pipe\gely.ipc`, true, `\\.\pipe\gely.ipc`},
	}
