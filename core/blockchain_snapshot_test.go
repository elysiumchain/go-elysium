...
// It can be used for testing that restart Gely normally.
...
// It can be used for testing that restart Gely after the crash.
...
// Tests a Gely restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gely was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gely was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gely was running with snapshot enabled. Then restarts without
...
// Tests the Gely was running with snapshot enabled and resetHead is applied.
...
// Tests the Gely was running with a complete snapshot and then imports a few
