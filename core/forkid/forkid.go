...
// NewID calculates the Elysium fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Elysium fork ID from an existing chain instance.
