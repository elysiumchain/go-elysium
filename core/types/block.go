...
// Package types contains data types related to Elysium consensus.
package types
...
// Header represents a block header in the Elysium blockchain.
type Header struct {
...
// Block represents an entire block in the Elysium blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Elysium RLP block format.
