...
type wizard struct {
	...
	services map[string][]string   // Elysium services known to be running on servers
...
// converts it to an Elysium address. If an empty line is entered, the default
// value is returned.
