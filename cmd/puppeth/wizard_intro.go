...
// setting up a new or managing an existing Elysium private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Elysium private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Elysium network down to  |")
	...
	log.Info("Administering Elysium network", "name", w.network)
