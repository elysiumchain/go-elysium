...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Elysium presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gely wallet import /path/to/my/presale.wallet

will prompt for your password and imports your ely presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Elysium presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gely wallet [options] /path/to/my/presale.wallet
...
between elysium nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gely account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gely account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another elysium instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gelyConfig{Node: defaultNodeConfig()}
	// Load config file.
