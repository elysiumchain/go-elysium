...
import (
	...
	"github.com/elysiumchain/go-elysium/internal/cmdtest"
	"github.com/elysiumchain/go-elysium/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gely-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gely-test" in runGely.
	reexec.Register("gely-test", func() {
...
// spawns gely with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGely(t *testing.T, args ...string) *testgely {
	tt := &testgely{}
	...
	// Boot "gely". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gely-test", args...)
