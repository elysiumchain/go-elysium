...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale elysium state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
gely snapshot prune-state <state-root>
...
during the use of Gely, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
gely snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
gely snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
gely snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gely dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gely dump', but uses the snapshots
