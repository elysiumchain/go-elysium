...
// mapped from textual names used in the tests below to actual Elysium private
...
// address retrieves the Elysium address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Elysium address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/elysiumchain/go-elysium/issues/17593). Whilst this
