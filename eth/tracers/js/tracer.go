...
import (
	...
	tracers2 "github.com/elysiumchain/go-elysium/eth/tracers"
	"github.com/elysiumchain/go-elysium/eth/tracers/js/internal/tracers"
...
// init retrieves the JavaScript transaction tracers included in go-elysium.
func init() {
