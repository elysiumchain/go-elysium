...
import (
	...
	"github.com/elysiumchain/go-elysium/p2p/msgrate"
...
// Syncer is an Elysium account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Elysium state over the
// snap protocol.
