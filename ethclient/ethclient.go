...
// Package ethclient provides a client for the Elysium RPC API.
package ethclient
...
// Client defines typed wrappers for the Elysium RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*elysium.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (elysium.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q elysium.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q elysium.FilterQuery, ch chan<- types.Log) (elysium.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q elysium.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg elysium.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg elysium.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg elysium.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg elysium.CallMsg) (uint64, error) {
...
func toCallArg(msg elysium.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *elysium.SyncProgress {
	if p == nil {
		return nil
	}
	return &elysium.SyncProgress{
